      ...
      <el-col :xs="18" :sm="18" :md="18" :lg="18" :xl="18">
        <div class="systemMain">
          ...
          <div class="systemMainContent">
            ...
            <div class="operation">
              <el-button round type="primary" @click="subscriptionClick(true)">
                订阅系统 <i class="el-icon-right"></i>
              </el-button>
              <el-button
                icon="el-icon-back"
                round
...
import {
  providerGroupList as _providerGroupList,
  providerProjectListByGroup as _providerProjectListByGroup,
  providerUpdateSysByProject as _providerUpdateSysByProject,
} from "@/api/common";
export default {
  components: {
    SubscriptionListPort,
  ...
  methods: {
    activeClickPort(i, v) {
      ...
      this.systemName = "";
      this.providerProjectListByGroup();
    },
    notCheckClick(V) {
      this.notCheckList = V;
    },
    ...
    providerProjectListByGroup() {
      _providerProjectListByGroup({
    ...
    subscriptionClick(v) {
      if (this.activeSystemMsg) {
        const data = {
          type: v ? 1 : 0,
          projectName: this.activeSystemMsg.groupName,
        ...
        if (data.list.length == 0) {
          ...
          _providerUpdateSysByProject(data).then((res) => {
