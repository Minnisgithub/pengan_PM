...
const token = process.env.NODE_ENV === 'development'?"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhZG1pbiIsInJvbGVzIjpbIkFETUlOIl0sImlzcyI6Im9kaW4ifQ.5ggDw7YYZ0FEXT4XOvILodWfo6UIvwnv0oGjPSn0hqI":localStorage.getItem('SETODINTOKEN')
// 平台安全运行时间
...
// 数据清理调度信息
export function messagesDataClean() {
    return request({
        url: '/api/v1/cleanup/messages?token='+token,
        method:'get',
    })
}
